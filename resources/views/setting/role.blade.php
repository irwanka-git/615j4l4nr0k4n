			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						...
						<h6 class="card-subtitle text-muted">Fitur Ini Digunakan Untuk Manajemen Akun Pengguna dan Hak Akses Jenis Pengguna</h6>
					</div>
					<div class="card-body">
						@if(Access::UserCanCreate())
				   		{{Html::btnModal('<i class="la la-plus-circle"></i> Tambah Jenis Pengguna','modal-tambah','primary')}}
				   		<hr>
				   		@endif
