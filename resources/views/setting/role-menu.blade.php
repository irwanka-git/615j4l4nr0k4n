			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Akses Menu :  {{$role->nama_role}}</h5>
...
<script type="text/javascript">
	...
	$(function(){
		...
		var $tabel1 = $('#datatable').DataTable({
		    ...
		    fixedHeader: true,
		    serverSide: true,
		    ajax: "{{url('setting-role/dt-menu/'.$role->uuid)}}",
		    "iDisplayLength": 25,
		    columns: [
		...
		$("#modal-edit").on('show.bs.modal', function(e){
			...
			$.get("{{url('setting-role/get-menu')}}/"+$uuid, function(respon){
				if(respon.status){
					$('#form-edit #nama_menu').val(respon.menu.nama_menu)
